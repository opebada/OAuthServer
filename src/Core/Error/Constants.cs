...
namespace Core.Error
{
    public class Constants
    {
        ...
        {
            public static ErrorResponse InvalidRequest = new ErrorResponse("invalid_request", "The request is invalid. A parameter is missing, add more than once or invalid");
